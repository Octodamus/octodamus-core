...
WIKI_ARTICLES = [
    "NVIDIA", "Tesla,_Inc.", "Bitcoin", "Ethereum",
    "Federal_Reserve", "Stock_market_crash", "Recession",
    "Inflation", "Interest_rate", "Iran", "Russia", "China",
    "Artificial_intelligence", "Bank_run",
]
