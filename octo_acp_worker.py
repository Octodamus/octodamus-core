...
def _get_report_type(event: dict) -> str:
    ...
    if any(k in all_text for k in ["silence signal", "silence_signal", "congressional silence", "congress_silence", "execution risk", "execution_risk"]):
        return "congressional_silence_signal"
